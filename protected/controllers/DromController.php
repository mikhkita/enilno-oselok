...
class DromController extends Controller
{
   private $drom_params = array(
    ...
    public function actionAdminVlad(){
        ...
        $url = (json_decode($curl->request("https://api.vk.com/method/photos.getMarketUploadServer?group_id=118079986&main_photo=1&v=5.50&access_token=5bafda61f16ad372a8e79d39b2090d0eaa03576846f16f8cb4e672ba9aea1dd55a7c08a997eb512b8fde9"))->response->upload_url);
        // print_r($url);
        ...
        $photo = $curl->request("https://api.vk.com/method/market.add?owner_id=-118079986&name=QWERTY&v=5.50&description=QWERTY123456&category_id=404&price=1111&main_photo_id=$photo&access_token=5bafda61f16ad372a8e79d39b2090d0eaa03576846f16f8cb4e672ba9aea1dd55a7c08a997eb512b8fde9");
        print_r($photo);
