...
class AdvertController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',
				'actions'=>array('adminIndex','adminSee','adminSeeList','adminUpdate','adminTitleEdit','adminUpDrom','adminRemove','admintitles','adminUpAvito','adminAction','adminFindById'),
				'roles'=>array('manager'),
			),
			array('allow',
	...
	{
		$advert = $this->loadModel($id);

		if(isset($_POST['id']))
		{
			$advert->url = $_POST['Advert']['url'];
			$advert->save();
