...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/html/tomsk/css/layout.css?<?=$css_version?>" type="text/css">

    <link rel="stylesheet" media="screen and (min-width: 240px) and (max-width: 767px)" href="<?php echo Yii::app()->request->baseUrl; ?>/html/tomsk/css/layout-mobile.css" />
            ...
            <div class="b b-sub-menu b-relative-top">
                <div class="b-block clearfix">
                    ...
                    <ul class="b-sub-menu-list clearfix left">
                        ...
                        <li class="not-mobile"><a href="<?=Yii::app()->createUrl('/kolesoOnline/category',array('type' => 3))?>">Правка дисков</a></li>
                        <li class="not-mobile"><a href="<?=Yii::app()->createUrl('/kolesoOnline/category',array('type' => 3))?>">Выкуп</a></li>
                        <li class="not-mobile"><a href="<?=Yii::app()->createUrl('/kolesoOnline/category',array('type' => 3))?>">Комиссия</a></li>
                    </ul>
                    <? if(!$mobile):?>
                ...
                <ul class="sections clearfix">
                    ...
                    <li>
                        ...
                        <? if(Yii::app()->params["city"]->id == 1081): ?>
                            <span class="footer-contacts map">г. Томск, Комсомольский проспект, 7</span>
                        <? else: ?>
                            <br>
                        <? endif; ?>
...
<script type="text/javascript" src="/html/tomsk/js/main.js"></script>
