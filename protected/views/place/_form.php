	...
	<? if($new): ?>
		<div class="clearfix">
			<div class="row left">
				...
				<?php echo $form->DropDownList($model,'category_id',CHtml::listData(Variant::model()->with('attribute')->findAll(array('order'=>'value ASC','condition'=>'attribute.attribute_id=57')), 'id', 'value'),array("style"=>"width:317px;")); ?>
	...
	<? else: ?>
		...
		<div class="row">
			<ul class="b-add-items">
				...
				<li>
					<p><span><?=$value->code?> (<?=$value->interpreter->id?> <?=$value->interpreter->name?>)</span><a href="#" class="b-add-remove">Удалить</a></p>
