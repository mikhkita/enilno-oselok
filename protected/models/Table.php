...
class Table extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, attribute_id_1, attribute_id_2', 'required'),
			array('name, rule_code', 'length', 'max'=>255),
			array('attribute_id_1, attribute_id_2', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, attribute_id_1, attribute_id_2, rule_code', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'values' => array(self::HAS_MANY, 'TableVariant', 'table_id'),
