			...
			<div class="b-block">
				...
				<div class="detail-wrap clearfix">
					...
					<div class="detail-desc left">
						...
						<ul>
							<li>Количество в комплекте:<span>4 шт</span></li>
							<li>Посадочный диаметр:<span>18"</span></li>
							<li>Ширина диска:<span>7.5"</span></li>
							<li>Вылет (ET):<span>37 мм.</span></li>
							<li>Сверловка (PCD):<span>114.30x5</span></li>
